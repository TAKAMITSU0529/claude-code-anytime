...
export default function ImportPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">My Clippings.txt をインポート</h1>

      <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm mb-6">
        <div className="mb-4 text-sm text-gray-600 space-y-2">
          <p>
            Kindle端末をPCに接続し、<code className="bg-gray-100 px-1 rounded">documents/My Clippings.txt</code> ファイルをアップロードしてください。
          </p>
